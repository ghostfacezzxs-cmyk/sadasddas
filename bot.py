...
admin_keys = {}
promote_requests = {}
orders = {}  # order_id -> {listing_id, buyer_id, seller_id, amount, status}
...
async def show_my_listing(msg, uid, index):
    ...
    await msg.answer_photo(l["photo_id"], caption=f"\u041e\u0431\u044a\u044f\u0432\u043b\u0435\u043d\u0438\u0435 #{l['id']}\n{l['description']}\n\n{index+1}/{len(ul)}", reply_markup=kb)
...
async def del_listing(call: types.CallbackQuery):
    ...
    if listing:
        ...
        users[uid]["listings_count"] = max(0, users[uid]["listings_count"] - 1)
...
async def help_cmd(msg: types.Message):
    text = (
        "\u2753 \u041f\u043e\u043c\u043e\u0449\u044c\n\n"
        "\U0001F4E6 \u041f\u0440\u043e\u0434\u0430\u0442\u044c \u0432\u0435\u0449\u044c \u2014 \u043e\u043f\u0443\u0431\u043b\u0438\u043a\u0443\u0439\u0442\u0435 \u043e\u0431\u044a\u044f\u0432\u043b\u0435\u043d\u0438\u0435 \u0441 \u0444\u043e\u0442\u043e \u0438 \u043e\u043f\u0438\u0441\u0430\u043d\u0438\u0435\u043c. \u041b\u0438\u043c\u0438\u0442: 2 \u043e\u0431\u044a\u044f\u0432\u043b\u0435\u043d\u0438\u044f \u0432 30 \u043c\u0438\u043d.\n\n"
        "\U0001F6D2 \u041f\u0440\u043e\u0441\u043c\u043e\u0442\u0440 \u043f\u0440\u043e\u0434\u0430\u0436 \u2014 \u0441\u043c\u043e\u0442\u0440\u0438\u0442\u0435 \u043e\u0431\u044a\u044f\u0432\u043b\u0435\u043d\u0438\u044f \u0434\u0440\u0443\u0433\u0438\u0445 \u0438\u0433\u0440\u043e\u043a\u043e\u0432. \u041a\u043d\u043e\u043f\u043a\u0430 \u041d\u0430\u043f\u0438\u0441\u0430\u0442\u044c \u043f\u043e\u0437\u0432\u043e\u043b\u044f\u0435\u0442 \u0441\u0432\u044f\u0437\u0430\u0442\u044c\u0441\u044f \u0441 \u043f\u0440\u043e\u0434\u0430\u0432\u0446\u043e\u043c.\n\n"
        "\U0001F4CB \u041c\u043e\u0438 \u043e\u0431\u044a\u044f\u0432\u043b\u0435\u043d\u0438\u044f \u2014 \u0441\u043c\u043e\u0442\u0440\u0438\u0442\u0435 \u0441\u0432\u043e\u0438 \u043e\u0431\u044a\u044f\u0432\u043b\u0435\u043d\u0438\u044f \u0438 \u0443\u0434\u0430\u043b\u044f\u0439\u0442\u0435 \u043d\u0435\u043d\u0443\u0436\u043d\u044b\u0435.\n\n"
        "\U0001F6A8 \u0420\u0435\u043f\u043e\u0440\u0442 \u2014 \u0435\u0441\u043b\u0438 \u0438\u0433\u0440\u043e\u043a \u043d\u0430\u0440\u0443\u0448\u0430\u0435\u0442 \u043f\u0440\u0430\u0432\u0438\u043b\u0430, \u043e\u043f\u0438\u0448\u0438\u0442\u0435 \u043f\u0440\u043e\u0431\u043b\u0435\u043c\u0443. \u0410\u0434\u043c\u0438\u043d\u0438\u0441\u0442\u0440\u0430\u0442\u043e\u0440 \u043e\u0442\u0432\u0435\u0442\u0438\u0442 \u0432\u0430\u043c.\n\n"
        "\U0001F4AC \u041f\u043e\u0434\u0434\u0435\u0440\u0436\u043a\u0430 \u2014 \u0435\u0441\u043b\u0438 \u0435\u0441\u0442\u044c \u0432\u043e\u043f\u0440\u043e\u0441 \u043f\u043e \u0440\u0430\u0431\u043e\u0442\u0435 \u0431\u043e\u0442\u0430, \u043d\u0430\u043f\u0438\u0448\u0438\u0442\u0435 \u0441\u044e\u0434\u0430.\n\n"
        "\U0001F464 \u041f\u0440\u043e\u0444\u0438\u043b\u044c \u2014 \u0432\u0430\u0448 \u0441\u0442\u0430\u0442\u0443\u0441, \u043a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u043e \u043e\u0431\u044a\u044f\u0432\u043b\u0435\u043d\u0438\u0439 \u0438 \u0438\u043d\u0444\u043e\u0440\u043c\u0430\u0446\u0438\u044f \u043e\u0431 \u0430\u043a\u043a\u0430\u0443\u043d\u0442\u0435."
    )
...
async def report_text(msg: types.Message, state: FSMContext):
    ...
    u = get_user(uid, uname)
    now = time.time()
    # антиспам: 2 репорта в 10 минут
    if "report_times" not in u:
        u["report_times"] = []
    u["report_times"] = [t for t in u["report_times"] if now - t < 600]
    ...
    # отправляем в группу админов с кнопкой
    kb = InlineKeyboardMarkup(inline_keyboard=[[
...
async def support_text(msg: types.Message, state: FSMContext):
    ...
    u = get_user(uid, uname)
    now = time.time()
    # антиспам: 2 обращения в 10 минут
    if "support_times" not in u:
        u["support_times"] = []
    u["support_times"] = [t for t in u["support_times"] if now - t < 600]
    ...
    # отправляем в группу поддержки с кнопкой
    kb = InlineKeyboardMarkup(inline_keyboard=[[
...
async def buy_start(call: types.CallbackQuery, state: FSMContext):
    ...
    if not listing:
        return await call.answer("\u041e\u0431\u044a\u044f\u0432\u043b\u0435\u043d\u0438\u0435 \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u043e.")
    await state.update_data(buy_listing_id=lid)
    await call.message.answer(f"\U0001F6D2 \u041f\u043e\u043a\u0443\u043f\u043a\u0430\n\n\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0441\u0443\u043c\u043c\u0443 \u0441\u0434\u0435\u043b\u043a\u0438 (\u0432 \u0432\u0430\u043b\u044e\u0442\u0435):")
...
async def buy_amount(msg: types.Message, state: FSMContext):
    ...
    deposit = round(amount * 0.20)
    await state.update_data(buy_amount=amount, buy_deposit=deposit)
    await msg.answer(
        f"\U0001F4B0 \u0421\u0443\u043c\u043c\u0430 \u0441\u0434\u0435\u043b\u043a\u0438: {int(amount):,}\n"
        f"\U0001F4B3 \u0417\u0430\u0434\u0430\u0442\u043e\u043a (20%): {deposit:,}\n\n"
        f"\u041f\u0435\u0440\u0435\u0432\u0435\u0434\u0438\u0442\u0435 {deposit:,} \u0432\u0430\u043b\u044e\u0442\u044b \u043d\u0430 ID: 1892508\n\n"
        f"\u0417\u0430\u0442\u0435\u043c \u043e\u0442\u043f\u0440\u0430\u0432\u044c\u0442\u0435 \u0441\u043a\u0440\u0438\u043d\u0448\u043e\u0442 \u043e\u043f\u043b\u0430\u0442\u044b:"
    )
    await state.set_state(S.buy_screenshot)

@dp.message(S.buy_screenshot, F.photo)
async def buy_screenshot(msg: types.Message, state: FSMContext):
    data = await state.get_data()
    uid = msg.from_user.id
    uname = msg.from_user.username or str(uid)
    lid = data["buy_listing_id"]
    amount = data["buy_amount"]
    deposit = data["buy_deposit"]
    listing = next((l for l in listings if l["id"] == lid), None)
    if not listing:
        await state.clear()
    ...
    await state.clear()
    await msg.answer(f"\u2705 \u041e\u0436\u0438\u0434\u0430\u0439\u0442\u0435 \u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u044f \u0432\u043d\u0435\u0441\u0435\u043d\u0438\u044f \u0437\u0430\u0434\u0430\u0442\u043a\u0430.\n\U0001F4CB \u041d\u043e\u043c\u0435\u0440 \u0437\u0430\u043a\u0430\u0437\u0430: #{order_id}")
    kb = InlineKeyboardMarkup(inline_keyboard=[[
...
async def confirm_order(call: types.CallbackQuery):
    ...
    seller_uname = order["seller_username"]
    try:
        await bot.send_message(order["buyer_id"],
            f"\u2705 \u0417\u0430\u0434\u0430\u0442\u043e\u043a \u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0451\u043d!\n\n"
            f"\U0001F464 \u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446: @{seller_uname}\n"
            f"\U0001F4CB \u0417\u0430\u043a\u0430\u0437: #{order_id}\n\n"
...
async def find_order(msg: types.Message):
    ...
    if len(parts) < 2: return await msg.answer("\u0424\u043e\u0440\u043c\u0430\u0442: /find #XXXXXX")
    order_id = parts[1].lstrip("#").upper()
    order = orders.get(order_id)
    if not order: return await msg.answer(f"\u0417\u0430\u043a\u0430\u0437 #{order_id} \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d.")
    status_map = {"pending": "\u041e\u0436\u0438\u0434\u0430\u0435\u0442 \u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u044f", "confirmed": "\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0451\u043d", "rejected": "\u041e\u0442\u043a\u043b\u043e\u043d\u0451\u043d"}
    await msg.answer(
        f"\U0001F4CB \u0417\u0430\u043a\u0430\u0437 #{order_id}\n\n"
        f"\U0001F4B0 \u0421\u0443\u043c\u043c\u0430: {int(order['amount']):,}\n"
        f"\U0001F4B3 \u0417\u0430\u0434\u0430\u0442\u043e\u043a: {int(order['deposit']):,}\n"
        f"\U0001F4CA \u0421\u0442\u0430\u0442\u0443\u0441: {status_map.get(order['status'], order['status'])}"
    )
